...
/*    val s3Client = S3Client.builder()
    ...
    extractParquetSchemaOld(bucketName, objectKey, accessKey, secretKey)
}

fun extractParquetSchemaOld(bucketName: String, objectKey: String, accessKey: String, secretKey: String) {
    try {
